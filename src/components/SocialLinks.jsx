...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/milind-kashyap",
    color: "#0A66C2",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@MilindKashyap",
    icon: Github,
    url: "https://github.com/MilindKashyap",
    color: "#ffffff",
  ...
  },
  {
    ...
    icon: ({ className, ...props }) => (
      <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M16.102 17.57l-2.747-2.746.742-.742 2.747 2.746-.742.742zm-9.499-9.5l-2.746 2.747.742.742 2.746-2.747-.742-.742zm9.195-8.708l-1.415 1.414-3.242 3.243-1.414-1.415-1.414 1.415 1.414 1.414-1.414 1.415-.707-.707-1.414 1.414 1.414 1.415-1.414 1.414 1.415 1.415 1.414-1.415 1.414 1.415 1.415-1.415 1.414-1.414-1.414-1.415 1.414-1.414-1.414 1.414-1.415-1.414-1.414 1.414-1.415-1.414-1.414 1.414-1.415-1.415-1.414 1.415-1.414.707.707 1.414-1.414-1.414-1.415 1.414-1.414 1.414 1.414 1.415-1.414 1.414-1.415 1.415 1.415 3.242-3.243 1.415-1.414zm-6.353 15.56l7.071-7.07.707.707-7.07 7.071-.708-.708z"/>
      </svg>
    ),
    url: "https://leetcode.com/u/MILINDKASHYAP/",
    color: "#FFA116",
...
const SocialLinks = () => {
  ...
  const [github, leetcode] = otherLinks;
  ...
  >
    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[github, leetcode].filter(link => link).map((link) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
